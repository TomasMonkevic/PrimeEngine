...
void TestGame::Awake()
{
	...
	sprite1 = new Sprite(Vector3(0, 0.0f, 0.1f), Vector2(3.2f, 4.8f), texture3, Vector4(0,0,1,1.0f));
	Sprite* sprite2 = new Sprite(Vector3(5, -0.5f, 0.1f), Vector2(1, 1), texture2);
